...
SHARE_PRETRAIN_DATA_PATH=./datasets/text_files/really_cleaned_share-captioner_coco_lcs_sam_1246k_1107.json
SHARE_FINETUNE_DATA_PATH=./datasets/text_files/cleaned_sharegpt4v_mix665k_cap23k_coco-ap9k_lcs3k_sam9k_div2k.json

SHARE_PRETRAIN_IMAGE_PATH=./datasets
SHARE_FINETUNE_IMAGE_PATH=./datasets


LLM_VERSION=pretrained_hg/Qwen1.5-4B
