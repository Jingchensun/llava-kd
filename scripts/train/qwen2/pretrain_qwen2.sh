...
~/miniconda3/bin/deepspeed --include localhost:0 --master_port 29501 tinyllava/train/train.py \
    ...
    --output_dir ./checkpoints/qwen2_llava_factory/tiny-llava-${LLM_VARIANT}-${VT_VARIANT}-${VERSION}-pretrain \
    --num_train_epochs 1 \
