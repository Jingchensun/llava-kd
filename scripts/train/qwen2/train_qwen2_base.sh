DATA_PATH=./datasets/text_files/blip_laion_cc_sbu_558k.json #pretrain annotation file path
FINETUNE_DATA_PATH=./datasets/text_files/llava_v1_5_mix665k.json #finetune annotation file path
IMAGE_PATH=./datasets/llava/llava_pretrain/images #pretrain image dir
FINETUNE_IMAGE_PATH=./datasets #finetune image dir

LLM_VERSION=pretrained_hg/Qwen2-0.5B # llm path in huggingface
