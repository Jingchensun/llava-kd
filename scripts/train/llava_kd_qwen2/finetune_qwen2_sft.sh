...
deepspeed --include localhost:0,1,2,3,4,5,6,7 --master_port 29501 llavakd/train/train_sft.py \
    ...
    --pretrained_model_path ./checkpoints/qwen25_distill_llava_factory/tiny-llava-${LLM_VARIANT}-${VT_VARIANT}-${VERSION}-pretrain \
    --output_dir ./checkpoints/qwen25_distill_llava_factory/tiny-llava-${LLM_VARIANT}-${VT_VARIANT}-${VERSION}-finetune \
    --num_train_epochs 1 \
